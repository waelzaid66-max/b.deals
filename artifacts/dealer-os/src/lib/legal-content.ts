// Public legal copy for the BANCO web legal pages (/privacy, /terms).
// This MIRRORS the in-app legal screens in artifacts/banco-mobile/app/legal/*.
// Keep both in sync whenever the policy text changes.

export type LegalSection = { heading: string; body: string; highlight?: boolean };
...
> = {
  ...
  ar: {
    ...
    langToggle: "English",
    backToApp: "بانكو",
    seePrivacy: "سياسة الخصوصية",
    seeTerms: "شروط الاستخدام",
  },
};

export const PRIVACY_SECTIONS: Record<LegalLang, LegalSection[]> = {
  en: [
    {
      heading: "Overview",
...
export const TERMS_SECTIONS: Record<LegalLang, LegalSection[]> = {
  en: [
    {
